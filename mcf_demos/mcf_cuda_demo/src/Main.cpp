...
#include "mcf_cuda_demo/ColourInverterComponent.h"
...
int main(int argc, char **argv)
{
    ...
    values::mcf_cuda_demo_value_types::registerMcfCudaDemoValueTypes(valueStore);
    ...
    auto colourInverterComponent = std::make_shared<mcf_cuda_demo::ColourInverterComponent>();
    auto colourInverterProxy = componentManager.registerComponent(colourInverterComponent);

    auto imageBlurringComponent = std::make_shared<mcf_cuda_demo::ImageFilterCudaComponent>();
